...
class TestRewriteMergedContext:
    ...
    def test_hard_filters_fields(self, mock_llm):
        ...
        assert query.hard_filters.education == "本科"
        assert query.hard_filters.location == "上海"
    ...
    def test_minimal_filters(self, mock_llm):
        ...
        assert query.hard_filters.education is None
        assert query.hard_filters.location is None
