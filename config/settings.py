...
SCORING_PROMPT_VERSION = os.getenv("SCORING_PROMPT_VERSION", "2026-04-28-v8")
...
AGENT_LLM_PROVIDER = os.getenv("AGENT_LLM_PROVIDER", DEFAULT_LLM_PROVIDER).strip()
AGENT_LLM_MODEL = os.getenv("AGENT_LLM_MODEL", "").strip() or None
AGENT_MAX_TOOL_ROUNDS = _env_int("AGENT_MAX_TOOL_ROUNDS", 8)
AGENT_HR_AUTO_MODE = _env_bool("AGENT_HR_AUTO_MODE", False)
OLLAMA_TOOL_CALLING = _env_bool("OLLAMA_TOOL_CALLING", False)

# Memory system (Phase 2)
MEMORY_AGENT_ENABLED = _env_bool("MEMORY_AGENT_ENABLED", True)
SESSION_CONTINUATION_THRESHOLD = _env_float("SESSION_CONTINUATION_THRESHOLD", 0.85)
SESSION_CONTINUATION_WINDOW_DAYS = _env_int("SESSION_CONTINUATION_WINDOW_DAYS", 7)
SEARCH_CACHE_TTL_HOURS = _env_int("SEARCH_CACHE_TTL_HOURS", 1)
MEMORY_RETRIEVAL_LIMIT = _env_int("MEMORY_RETRIEVAL_LIMIT", 5)
